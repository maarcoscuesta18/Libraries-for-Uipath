...
namespace ReadBarcodesQR
{
    ...
    public class ExtractQR : CodeActivity{
        [Category("Input")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            if (result != null){
                Console.WriteLine("QR content: " + result.Text);
                ...
                Console.WriteLine("QR can't be decoded, check the quality of the image");
                throw new Exception("QR can't be decoded, check the quality of the image");
            }
        }
    }
}
